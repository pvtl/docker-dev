...
Follow the "Daily Shortcuts" section again in the README to update your aliases. Then run `devin 85` again and check the Node.js version.

If you're manually running `docker exec -it php85 bash`, you'll need to update the command to `docker exec -it php85 zsh` (ie. use ZSH instead of BASH).
